 ...
 * clockwise rotate
 * Swap top and bottom row, then swap the symmetry
 * 1 2 3     7 8 9     7 4 1
 * 4 5 6  => 4 5 6  => 8 5 2
 * 7 8 9     1 2 3     9 6 3

 * anticlockwise rotate
 * Swap left and right columns, then swap the symmetry
 * 1 2 3     3 2 1     3 6 9
 * 4 5 6  => 6 5 4  => 2 5 8
 * 7 8 9     9 8 7     1 4 7
...
class Solution:
    ...
    def rotate_matrix(self, matrix):
        # check the idea for clockwise and anti-cl.. rotation above
